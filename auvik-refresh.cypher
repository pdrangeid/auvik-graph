...
SET ad.devicename=lowercase(trim(apoc.text.replace(device.attributes.deviceName,regex,''))),ad.swversion=device.attributes.softwareVersion,ad.fwversion=device.attributes.firmwareVersion,ad.modified=device.attributes.lastModified
